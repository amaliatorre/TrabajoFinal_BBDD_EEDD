...
public class DBManager {
    ...
    /**
     * ConfiguraciÛn de la conexiÛn a la base de datos
     */
    /**
     * cte nombre de host 
     */
    ...
    /**
     * Comprueba la conexiÛn y muestra su estado por pantalla
     *
     * @return true si la conexiÛn existe y es v·lida, false en caso contrario
     */
    public static boolean isConnected() {
        // Comprobamos estado de la conexiÛn
        try {
    ...
    /**
     * Cierra la conexiÛn con la base de datos
     */
    public static void close() {
        try {
            System.out.print("Cerrando la conexiÛn...");
            conn.close();
            System.out.println("OK!");
        } catch (SQLException ex) {
            ex.printStackTrace();
